...
description: "PAX(preview) · 로컬에서 private GitHub repo를 clone/push 하기 위한 GitHub 인증 안내. \"GitHub 로그인\", \"clone 권한 없음\", \"push가 안 됨\" 등에 사용."
---
# 로컬 GitHub 인증
...
- PAX 연결(`/pax-preview:connect`)에는 gh 가 필요 없습니다 — 이 로그인은 clone/push 용입니다. 해당 repo 에 권한이 있는 GitHub 계정으로 로그인하세요. `git ls-remote` 가 성공하면 이 단계를 통째로 건너뛰세요.
